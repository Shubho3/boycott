...
//   Horizontalcard(
//       {Key? key, required this.orderdetailsdata, required this.refresh})
//       : super(key: key);
//   @override
...
//                       orderid: widget.orderdetailsdata['order_id'].toString(),
//                       orderData: {},
//                     )),
//           );
//         } else {
...
//                         orderDetail: widget.orderdetailsdata,
//                         product: widget.orderdetailsdata['products'],
//                         agent: widget.orderdetailsdata['agent_info'],
//                         customer: widget.orderdetailsdata['customer_info'],
//                         order_id: widget.orderdetailsdata['id'],
//                         date: 'date',
...
//                               children: [
//                                 Text(
//                                   '${widget.orderdetailsdata['products'].length.toString()} Products on this Order',
//                                   style: TextStyle(
...
//                                 // return;
//                                 // Navigator.pushNamed(context, Checkout.id);},
//                                 if (widget.orderdetailsdata['order_id']
//                                         .toString() !=
//                                     '0') {
//                                   Navigator.push(
//                                     MyGlobalKeys.tabBarKey.currentContext!,
...
//                                               agent: widget.orderdetailsdata[
//                                                   'agent_info'],
//                                               customer: widget.orderdetailsdata[
//                                                   'customer_info'],
//                                               order_id:
//                                                   widget.orderdetailsdata['id'],
//                                               date: 'date',
//                                               reffid: widget
//                                                   .orderdetailsdata['ref_id'],
//                                               recomenid: widget
//                                                   .orderdetailsdata['id'])));
//                                 }
//
...
//                                 mainAxisAlignment: MainAxisAlignment.center,
//                                 children: [
//                                   if (widget.orderdetailsdata['is_seen']
//                                           .toString() !=
//                                       '1')
//                                     Container(
...
//                                         child: Text(
//                                           widget.orderdetailsdata['is_seen']
//                                                       .toString() !=
//                                                   '1'
//                                               ? 'NUVEO'
//                                               : 'ABIERTO',
...
//                                     for (int p = 1;
//                                         p <
//                                             widget.orderdetailsdata['products']
//                                                 .length;
//                                         p++)
...
//                                                           .length >
//                                                       p
//                                                   ? '${widget.orderdetailsdata['products'][p]['images'][0]['image']}'
//                                                   : '${widget.orderdetailsdata['products'][p]['image']}',
//                                               height: 35,
//                                               width: 40,
//                                               fit: BoxFit.cover,
//                                             ),
...
//                                 Image.network(
//                                   widget
//                                               .orderdetailsdata['products'][0]
//                                                   ['images']
//                                               .length >
//                                           0
//                                       ? '${widget.orderdetailsdata['products'][0]['images'][0]['image']}'
//                                       : '${widget.orderdetailsdata['products'][0]['image']}',
//                                   height: 80,
//                                   width: 80,
//                                   fit: BoxFit.cover,
//                                 ),
...
//                                     width: 8,
//                                   ),
//                                   if (widget.orderdetailsdata['agent_info'] !=
//                                       false)
//                                     Text(
//                                       'Reffered By :${widget.orderdetailsdata['agent_info']['f_name'] + "  " + widget.orderdetailsdata['agent_info']['l_name']} ',
//                                       style: TextStyle(
//                                           fontSize: 10,
//                                           color: Color(0xff6b6b6b)),
//                                     )
...
//                       ),
//                       Text(
//                         'Product Code: ${widget.data['product_code']}',
//                         style: TextStyle(
//                             color: Colors.black,
//                             fontFamily: 'regular',
//                             fontSize: 10),
...
//                                     onTap: int.parse(widget.data['qty'] == null
//                                                 ? '0'
//                                                 : widget.data['qty']
//                                                     .toString()) <=
//                                             0
...
//                 Padding(
//                   padding: const EdgeInsets.only(
//                       left: 10, right: 16, bottom: 05, top: 0),
//                   child: Text(
...
//                               children: <TextSpan>[
//                                 for (var i = 0;
//                                     i < data['store_id'].length;
//                                     i++)
//                                   TextSpan(
//                                       text:
//                                           '${data['store_id'][i]['store_name']}',
//                                       style: TextStyle(
...
//                                 children: <TextSpan>[
//                                   TextSpan(
//                                       text: data['warranty_month'].toString() !=
//                                               '0'
//                                           ? '${data['warranty_month']} month'
//                                           : 'Without Warranty',
//                                       style: TextStyle(
//                                           fontWeight: FontWeight.w700)),
//                                 ],
