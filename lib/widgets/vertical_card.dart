...
//               'Macbook Pro M1',
//               style: TextStyle(
//                   color: Colors.black, fontFamily: 'semibold', fontSize: 15),
//             ),
//           ),
//           Padding(
//             padding:
//                 const EdgeInsets.only(left: 10, right: 16, bottom: 0, top: 0),
//             child: Text(
