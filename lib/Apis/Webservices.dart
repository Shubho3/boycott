  ...
  static Future<Map<String, dynamic>> postData(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonResponse['status'].toString() == '1' ||jsonResponse['status']
            .toString() == 'true') {
                          print("if");
...
class ApiUrls {
  static const baseUrl = 'https://server-php-7-3.technorizen.com/Timetrekz/api/';

  // static const String getpaymentMethodFromSecretKey = 'https://api.stripe.com/v1/setup_intents/';

  static const login = '${baseUrl}login';
  static const check_otp = '${baseUrl}check_otp';
  static const get_banner = '${baseUrl}get_banner';
  static const get_category = '${baseUrl}get_category';
  static const add_category = '${baseUrl}add_category';
  static const add_event = '${baseUrl}add_event';
  static const get_event = '${baseUrl}get_event';
  static const get_place = '${baseUrl}get_place';
  static const addPlace = '${baseUrl}add_place';
  static const addTravels = '${baseUrl}add_travels';
  static const getTravels = '${baseUrl}get_travels';
  static const delete_travels = '${baseUrl}delete_travels';
  static const addLocation = '${baseUrl}add_location';
  static const terms = baseUrl + 'terms_conditions';
  static const privacy = baseUrl + 'privacy_policy';
  static const faq = baseUrl + 'get_faqs';
  static const contactUs = baseUrl + 'contact_info';
  static const updateDeviceToken = baseUrl + 'updatedeviceid';
  static const addfav = baseUrl + 'add_fav';
  static const getFav = baseUrl + 'get_wish_list_event';
  static const getNotification = baseUrl + 'get_notification';
}
